...
(function ($) {
  ...
  if ($("body").hasClass("tt-transition")) {
      ...
      $phCaptionAppear.each(function () {
        ...
        $this.contents().each(function () {
          if (this.nodeType === 3) {
            ...
            let $wrappedElement = $(
              '<span class="tt-cap-word-wrap"><span class="tt-cap-word"></span></span>'
            );
            // Clone the current element and append it inside the newly created structure
            $wrappedElement
              .find("span.tt-cap-word")
              .append($thisElement.clone(true));
    ...
    function ttAnimateTransitionIn() {
      let tl_transitIn = gsap.timeline({
        defaults: { duration: $tt_ptrDuration, ease: Expo.easeInOut },
      });
      ...
      if ($tt_pageTransition.length) {
        ...
        tl_transitIn.to(
          $tt_ptrOverlayTop,
          { scaleX: 1, transformOrigin: "center left" },
          0
        );
        tl_transitIn.to(
          $tt_ptrOverlayBottom,
    ...
    function ttAnimateTransitionOut() {
      ...
      if ($(".ph-caption-categories").length) {
        tl_transitOut.from(
          ...
          { y: 20, autoAlpha: 0, ease: Power2.easeOut, clearProps: "all" },
          1.8
        );
      }
      ...
      if ($(".tt-scroll-down").length) {
        tl_transitOut.from(
          ...
          { y: 80, autoAlpha: 0, ease: Power2.easeOut, clearProps: "all" },
          1.7
        );
      }
    }
  ...
  function hasScrolled() {
    ...
    if (st > lastScrollTop && st > navbarHeight) {
      ...
      if (tt_Header.hasClass("tt-header-filled")) {
        if (
          tt_Header.hasClass("tt-header-scroll") ||
          tt_Header.hasClass("tt-header-fixed")
        ) {
          if (st > delta) {
            let lightMode = localStorage.getItem("tt-lightmode-on");

            if (lightMode === "enabled" || lightMode === null) {
              tt_Header.addClass("tt-filled-light");
              tt_Header.removeClass("tt-filled");
            } else {
              tt_Header.removeClass("tt-filled-light");
  ...
  $(".tt-style-switch").on("click", function () {
    if (localStorage.getItem("tt-lightmode-on") === "enabled") {
      $(".ph-video-inner").addClass("opacity-10");
    } else {
      $(".ph-video-inner").removeClass("opacity-10");
    }
    ...
    if (tt_isMobile) {
      ...
      $(document).on("click", function (e) {
        ...
        if (ttNoFirstClick.length) {
          ...
          ttSubmenuTriggers
            .closest(".tt-submenu-trigger")
            .addClass("tt-no-first-click");
        }
      });
    }
  }
  ...
  $("#tt-m-menu-toggle-btn-wrap").on("click", function () {
    ...
    if ($("body").hasClass("tt-m-menu-open")) {
      $("#tt-header").css("overflow", "visible");
      ...
      tl_mMenuIn.from(".tt-main-menu-content > ul > li", {
        duration: 0.4,
        y: 80,
        autoAlpha: 0,
        stagger: 0.05,
      ...
      $(
        '.tt-submenu-trigger > a[href="#"], .tt-submenu-trigger > a[href="#0"], .tt-submenu-trigger > a[href=""]'
      )
        .parent(".tt-submenu-trigger")
        .append('<span class="tt-submenu-trigger-m"></span>'); // if href contains #
      ...
      $(".tt-main-menu a, .tt-logo a")
        ...
        .on("click", function () {
          ...
          tl_mMenuClick.to(".tt-main-menu-content > ul > li", {
            duration: 0.4,
            y: -80,
            autoAlpha: 0,
            stagger: 0.05,
          ...
          tl_mMenuClick.set(".tt-main-menu-content > ul > li", {
            clearProps: "all",
          });
        });
      ...
      function ttCloseMobileMenu() {
        ...
        gsap.set(".tt-main-menu, .tt-main-menu-content > ul > li", {
          clearProps: "all",
        });
      }
      ...
      tl_mMenuOut.to(".tt-main-menu-content > ul > li", {
        duration: 0.4,
        y: -80,
        autoAlpha: 0,
        stagger: 0.05,
  ...
  $(".ttgr-cat-trigger").on("click", function () {
    ...
    if ($("body").hasClass("ttgr-cat-nav-open")) {
      ...
      gsap.to("#page-header, #tt-header, .ttgr-cat-trigger", {
        duration: 0.3,
        autoAlpha: 0,
      });
      ...
      tl_ttgrIn.from(".ttgr-cat-close-btn", {
        duration: 0.3,
        y: 10,
        autoAlpha: 0,
        ease: Power2.easeIn,
  ...
  function ttCatNavClose() {
    ...
    $(".ttgr-cat-nav, .ttgr-cat-close-btn").on("click", function (e) {
      if (
        $("body").hasClass("ttgr-cat-nav-open") &&
        !$ttgrCatNavList.is(e.target) &&
        $ttgrCatNavList.has(e.target).length === 0
      ) {
        $("body").removeClass("ttgr-cat-nav-open");

        // Catecories step out animations
        let tl_ttgrClose = gsap.timeline();
        tl_ttgrClose.to(".ttgr-cat-close-btn", {
          duration: 0.3,
          y: -10,
          autoAlpha: 0,
          ease: Power2.easeIn,
        ...
        tl_ttgrClose.to(
          "#page-header, #tt-header, .ttgr-cat-trigger",
          { duration: 0.3, autoAlpha: 1, clearProps: "all" },
          "-=0.4"
        );
        tl_ttgrClose.to(".ttgr-cat-list > li, .ttgr-cat-close-btn", {
          clearProps: "all",
        }); // clearProps only
  ...
  if ($(".tt-ppli-preview").length) {
    ...
    function ttEnableMouseFollow() {
      ...
      let $xTo = gsap.quickTo($ppliPreview, "x", {
        duration: $pplipDuration,
        ease: $pplipEase,
      });
      let $yTo = gsap.quickTo($ppliPreview, "y", {
        duration: $pplipDuration,
        ease: $pplipEase,
      });
  ...
  $(".tt-sticky-portfolio").each(function () {
    ...
    $ttStPortfItem.each(function (index) {
      ...
      if ($("#tt-header").is(".tt-header-fixed, .tt-header-scroll")) {
        ...
        $(".tt-stp-item").css(
          "min-height",
          "calc(100vh - " + $ttStPortfOffset * 1.4 + "px)"
        );
      } else {
        var $ttStPortfOffset = 40;
        $(".tt-stp-item").css(
          "min-height",
          "calc(100vh - " + $ttStPortfOffset * 2 + "px)"
        );
      }
      ...
      if (!$this.is(":last-child")) {
        ...
        if (tt_isMobile) {
          ...
          tl_ttStPortfItem.to(
            $this.find(".tt-stp-item-image img, .tt-stp-item-video video"),
            { scale: 1.15 },
            0
          );
  ...
  if ($ttPortfolioSlider.length) {
    ...
    if (
      $ttPortfolioSlider.is(
        '.cursor-drag-mouse-down[data-direction="vertical"]'
      )
    ) {
    ...
    var $data_ttPoslAutoplay = $ttPortfolioSlider.data("autoplay")
      ? {
  ...
  $(".tt-sticky-horizontal-scroll").each(function () {
    ...
    const ttShsAnimDistance = () =>
      -($ttShsAnimWrap[0].scrollWidth - window.innerWidth);
      ...
      $(".tt-sticky-element").each(function () {
        ...
        const trigger = ScrollTrigger.create({
          ...
          start: "top " + $ttPinElementOffset,
            ...
            "+=" + ($ttPinScroller.outerHeight() - $ttPinElement.outerHeight()),
          pin: $ttPinElement,
          markers: false,
        });
  ...
  $(".tt-sticky-testimonials").each(function () {
    ...
    $ttStteItem.each(function (index) {
      ...
      if ($("#tt-header").is(".tt-header-fixed, .tt-header-scroll")) {
        ...
        $(".tt-stp-item").css(
          "min-height",
          "calc(100vh - " + ttStTestimOffset * 1.4 + "px)"
        );
      } else {
        var ttStTestimOffset = 60;
        $(".tt-stp-item").css(
          "min-height",
          "calc(100vh - " + ttStTestimOffset * 2 + "px)"
        );
      }
  ...
  if ($(".tt-content-slider").length) {
    $(".tt-content-slider").each(function () {
      ...
      // Data attributes
      // ================
      var $data_ttCsAutoplay = $ttContentSlider.data("autoplay")
        ? {
            delay: $ttContentSlider.data("autoplay"),
            disableOnInteraction: true,
          }
        : $ttContentSlider.data("autoplay");
      ...
      var $tt_simulateTouch =
        $(".tt-cs-nav-prev").hasClass("cursor-arrow-left") ||
        $(".tt-cs-nav-next").hasClass("cursor-arrow-right")
          ? false
          : true;

      // Init Swiper
      // ============
      var $ttContentSliderSwiper = new Swiper(
        $ttContentSlider.find(".swiper")[0],
        {
          // Parameters
  ...
  if ($(".tt-content-carousel").length) {
    $(".tt-content-carousel").each(function () {
      ...
      var $data_ttCcAutoplay = $ttContentCarousel.data("autoplay")
        ? {
      ...
      if ($ttContentCarousel.is("[data-pagination-type]")) {
        var $data_ttCcPaginationType =
          $ttContentCarousel.data("pagination-type");
      } else {
  ...
  $(".tt-scrolling-text").each(function () {
    ...
    let $tt_scrtTween = gsap
      .to($this.find(".tt-scrt-content"), {
  ...
  $(".tt-accordion").each(function () {
    ...
    $ttAccordion.find(".tt-accordion-heading").on("click", function () {
      ...
      if ($ttAccItem.hasClass("active")) {
        ...
        $ttAccordion
          .find(".tt-accordion-item.active")
          .removeClass("active")
          .find(".tt-accordion-content")
          .slideUp(350);
        $ttAccItem.addClass("active");
  ...
  gsap.to(".tt-accordion", {
    duration: 0.5,
    ease: "power2.inOut",
    scrollTrigger: {
      trigger: ".tt-accordion",
      start: "top top",
      end: "bottom top",
      scrub: true,
      onLeave: function () {
        ...
        $(".tt-accordion").each(function () {
          ...
          $ttAccordion.find(".tt-accordion-item").each(function () {
            let $ttAccItem = $(this);
            // console.log($ttAccItem.find(".tt-accordion-content"));
            if ($ttAccItem.find(".tt-accordion-content")) {
              // console.log("if");
              $ttAccItem.removeClass("active");
              $ttAccItem.find(".tt-accordion-content").slideUp(350);
            }
          });
        });
      },
  ...
  $(".tt-horizontal-accordion").each(function () {
    ...
    function ttHorAccItemSize() {
      setTimeout(function () {
        ...
        let $ttHorAccItemInner =
          $ttHorAccFirtItem.find(".tt-hac-item-inner").width() * 0.84;
  ...
  if ($("form").hasClass("tt-form-creative")) {
    ...
    $('input:not([type="checkbox"]):not([type="radio"]), textarea, select').on(
      "input",
      function () {
        $(this)
          .parent()
          .toggleClass("tt-fg-typing", this.value.trim().length > 0);
      }
    );
  }
  ...
  $ttContactForm.submit(function (e) {
    ...
    $cfmContainerInner
      .empty()
      .html('<span class="tt-cfm-sending">Sending your message...</span>');
    ...
    $.ajax({
      ...
      .done(function (response) {
        ...
        if (response.success) {
          ...
          $cfmContainerInner.html(
            '<span class="tt-cfm-success">' + response.message + "</span>"
          ); // Look at the "mail.php" file to change this response message text.
          ...
          $cfmContainerInner.html(
            '<span class="tt-cfm-error">' + response.message + "</span>"
          ); // Look at the "mail.php" file to change this response message text.
        }
      ...
      .fail(function () {
        ...
        $cfmContainerInner
          .empty()
          .html(
            '<span class="tt-cfm-error">An error occurred. Please try again later.</span>'
          );
    ...
    function scrollToContactFormTop() {
      if (!tt_isMobile) {
        ...
        if ($("body").hasClass("tt-smooth-scroll")) {
          const cfmTopY =
            $ttContactForm.offset().top - $("body").offset().top - 240;
          ...
          $("html, body").animate(
            { scrollTop: $ttContactForm.offset().top - 240 },
            600
          );
        }
      } else {
  ...
  $('a[href^="#"]')
    ...
    .on("click", function (e) {
      ...
      if ($(this).data("offset") != undefined)
        $tt_sbaOffset = $(this).data("offset");

      let $tt_sbaTopY =
        $($tt_sbaTarget).offset().top - $("body").offset().top - $tt_sbaOffset;
      if ($("body").hasClass("tt-smooth-scroll")) {
        if (!tt_isMobile) {
  ...
  if ($(".tt-scroll-to-top").length) {
    ...
    $tt_SttProgressPath.style.transition =
      $tt_SttProgressPath.style.WebkitTransition = "none";
    $tt_SttProgressPath.style.strokeDasharray =
      $tt_SttPathLength + " " + $tt_SttPathLength;
    $tt_SttProgressPath.style.strokeDashoffset = $tt_SttPathLength;
    $tt_SttProgressPath.style.transition =
      $tt_SttProgressPath.style.WebkitTransition =
    ...
    $(window).on("scroll", function () {
      ...
      var $tt_SttProgress =
        $tt_SttPathLength - ($tt_SttScroll * $tt_SttPathLength) / $tt_SttHeight;
  ...
  $(".tt-image-parallax").each(function () {
    ...
    // Add wrap <div>
    $animImageParallax.wrap(
      '<div class="tt-image-parallax-wrap"><div class="tt-image-parallax-inner"></div></div>'
    );
  ...
  $(".tt-anim-fadeinup").each(function () {
    ...
    let $fadeInUpDelay =
      $("body").hasClass("tt-transition") &&
      ScrollTrigger.isInViewport($this[0], 0.2)
        ? 1.2
        : 0.3;
    tl_FadeInUp.from(
      $this,
  ...
  $(".tt-clipper").each(function () {
    ...
    const $clipPathValue = $isInWrap
      ? "inset(0% round var(--_tt-clipper-radius))"
      : "inset(0% round 20px)";
  ...
  if ($(".tt-grid-categories").length) {
    ...
    if ($ttgCatTriggerWrap.hasClass("ttgr-cat-fixed")) {
      ...
      function ttgCatShow() {
        tl_ttgrCatFilter.to($ttgCatTriggerHolder, {
          duration: 0.4,
          autoAlpha: 1,
          scale: 1,
          ease: Power2.easeOut,
    ...
    if ($(window).width() > 1024) {
      ...
      $(".magnetic-wrap")
        .on("mouseenter", function (e) {
          ...
          gsap.to($ball, {
            duration: 0.3,
            width: $ballMagneticWidth,
            height: $ballMagneticHeight,
            opacity: 1,
          });
          $ballActive = true;
        })
        .on("mouseleave", function (e) {
          ...
          gsap.to(this.querySelector(".tt-magnetic-item"), {
            duration: 0.3,
            x: 0,
            y: 0,
            clearProps: "all",
          ...
          if ($(this).parent().hasClass("cursor-drag")) {
            $(this)
              ...
              .on("mouseenter", function () {
                $ball
                  .addClass("ball-drag")
                  .append('<div class="ball-drag-inner"></div>');
                gsap.to($ball, {
                  duration: 0.3,
                  yPercent: -75,
                  width: $ballDragWidth,
                  height: $ballDragHeight,
                  opacity: 1,
                });
              })
              .on("mouseleave", function () {
                $ball
                  .removeClass("ball-drag")
                  .find(".ball-drag-inner")
                  .remove();
                gsap.to($ball, {
                  duration: 0.3,
                  yPercent: -50,
              ...
              .on("mousedown pointerdown", function (e) {
                if (e.which === 1) {
                  ...
                  gsap.to($ball, {
                    duration: 0.3,
                    yPercent: -50,
                    width: $ballDragMouseDownWidth,
                    height: $ballDragMouseDownHeight,
                    opacity: 1,
                  });
                  $ball
                    .addClass("ball-drag-mouse-down")
                    .append('<div class="ball-drag-mouse-down-inner"></div>');
                }
              })
              .on("mouseup pointerup", function () {
                $ball
                  .removeClass("ball-drag-mouse-down")
                  .find(".ball-drag-mouse-down-inner")
                  .remove();
      ...
      $(".cursor-arrow-left")
        .on("mouseenter", function () {
          $ball
            .addClass("ball-arrow")
            .append('<div class="ball-arrow-left"></div>');
          gsap.to($ball, {
            duration: 0.3,
            yPercent: -70,
            width: $ballArrowWidth,
            height: $ballArrowHeight,
            opacity: 1,
          });
        })
        .on("mouseleave", function () {
      ...
      $(".cursor-arrow-right")
        .on("mouseenter", function () {
          $ball
            .addClass("ball-arrow")
            .append('<div class="ball-arrow-right"></div>');
          gsap.to($ball, {
            duration: 0.3,
            yPercent: -70,
            width: $ballArrowWidth,
      ...
      function ttShowCursorClose() {
        ...
        gsap.to($ball, {
          duration: 0.3,
          yPercent: -75,
          width: $ballCloseWidth,
          height: $ballCloseHeight,
          opacity: 1,
        });
        gsap.from(".ball-close-inner", {
          duration: 0.3,
          scale: 0,
          autoAlpha: 0,
        });
      ...
      $(".cursor-close").each(function () {
        ...
        $this
          .on("mouseenter", ".hide-cursor", function () {
            ttHideCursorClose();
          })
        ...
        $this.on("click", function (e) {
          ...
          if (
            !$ttPreventCursorClose.is(e.target) &&
            $ttPreventCursorClose.has(e.target).length === 0
          ) {
            ttHideCursorClose();
          }
        });
